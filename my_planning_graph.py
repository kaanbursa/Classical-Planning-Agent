...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any(~a == b for a,b in product(actionA.effects,actionB.effects))
    ...
    def _interference(self, actionA, actionB):
        ...
        return any(~effect == precondition for effect,precondition in
            chain(
            product(actionA.effects,actionB.preconditions),
            product(actionA.preconditions,actionB.effects)))
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any(self.parent_layer.is_mutex(precondA,precondB) for precondA,precondB in product(actionA.preconditions,actionB.preconditions)
        )
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        return all(self.parent_layer.is_mutex(actA,actB) for actA,actB in product(self.parents[literalA],self.parents[literalB]))
...
class PlanningGraph:
    ...
    def h_levelsum(self):
        ...
        # target is [At(C1, JFK), At(C2, SFO)]

        cost = 0
        for goal in target:
            for idx,l in enumerate(self.literal_layers):
                if goal in l:
                    cost += idx
                    break
